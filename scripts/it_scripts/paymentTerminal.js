...
function onDisplaysNone() {
    var input = "<div class=\"container-fluid\"><div class=\"row align-items-center\"><div class=\"col-3\"></div><div class=\"col-6\"><img src=\"assets\\itAssets\\cardReaderPlug.jpeg\" class=\"img-fluid\" alt=\"card reader plug\"><br><br><h3>Steps:</h3><h5><br><br>1. Unplug the power to the card reader. The image attached above is where power should be unplugged from.<br><br>2. Shut Down WinPos. If on Register 1, STOP MI9 STORE<br><br>3. Restart Computer<br><br>4. Once the computer has completely come back up, plug the power back into the card reader.<br><br>5. (Subject to Change) The Card reader will begin to boot up. It should go in the order of: Verifone Screen, System Information, Synchronizing With XPI App, System Information, then back to the Ads. If this didn't happen, it's likely you'll have to restart from step 1.</h5></div><div class=\"col-3\"></div></div></div>";
